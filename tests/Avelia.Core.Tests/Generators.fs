...
module Gen =
    ...
    let branchName : Gen<BranchName> =
        ...
        let allowedNoSlash = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_"
        gen {
            ...
            let s =
                System.String(
                    Array.append
                        (Array.append [| head |] (List.toArray mid))
                        [| tail |])
    ...
    let modelChoice : Gen<ModelChoice> =
        Gen.elements [ Sonnet45; Opus41; Haiku45 ]
