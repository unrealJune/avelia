...
**Test count after Chunks 0–4 + Chunk 6 + W-1..W-5 fixes: 158 passing** (54 Avelia.Core, 100 Avelia.Shell.Windows — adds 23 PrReview VM + DiffLine/Hunk projection tests plus 3 W-3/W-5 regression guards and 6 new W-4 contrast pairings on top of Chunk 4's 68, plus 4 from the other F# test projects). Build is clean — 0 warnings, 0 errors. Chunk 5 (Settings) is in flight on a separate branch.
